...
public class ReturnListener implements ActionListener{
   ...
   public void actionPerformed(ActionEvent e){
      NumberConverter.logger.log("EnterListener was triggered...");
      if(e.getSource() == NumberConverter.ui.binaryText){
         String s = NumberConverter.ui.binaryText.getText().replaceAll("[^01]", "");

         NumberConverter.logger.log("binary: " + ((JTextField)e.getSource()).getText() + " -> " + s);
         NumberConverter.logger.log(s.length() > 21 ? "binary was shorten" : "binary was not shorten");
         ...
         NumberConverter.logger.log("changed content: [" + NumberConverter.ui.binaryText.getText() + "]-[" + NumberConverter.ui.octalText.getText() +
         ...
         NumberConverter.logger.log("octal: " + ((JTextField)e.getSource()).getText() + " -> " + s);
         NumberConverter.logger.log(s.length() > 21 ? "octal was shorten" : "octal was not shorten");
         ...
         NumberConverter.logger.log("decimal: " + ((JTextField)e.getSource()).getText() + " -> " + s);
         NumberConverter.logger.log(s.length() > 21 ? "decimal was shorten" : "decimal was not shorten");
         ...
         NumberConverter.logger.log("hex: " + ((JTextField)e.getSource()).getText() + " -> " + s);
         NumberConverter.logger.log(s.length() > 21 ? "hex was shorten" : "hex was not shorten");
